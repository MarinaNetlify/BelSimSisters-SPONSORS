    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <button className="px-3 py-1 border border-white/40 text-white text-xs font-headline font-bold tracking-wider hover:bg-white/10 transition-colors duration-300 rounded">
            RU
          </button>
          <button className="px-3 py-1 border border-white/40 text-white text-xs font-headline font-bold tracking-wider hover:bg-white/10 transition-colors duration-300 rounded">
            BY
