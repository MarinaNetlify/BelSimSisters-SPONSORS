      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <motion.div
          ...
          <motion.button
            ...
            className="bg-black text-white px-12 py-6 text-2xl font-headline font-bold tracking-wider hover:bg-white hover:text-black transition-colors duration-300 skew-x-[-10deg] shadow-2xl">
        ...
        <div className="mt-12 text-white/80 font-body tracking-widest">
          CONTACT: HELLO@BELSWIMSISTERS.COM
        </div>
      </div>
    </section>);
