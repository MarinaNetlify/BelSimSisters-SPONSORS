...
export function CallToAction() {
  ...
  return (
    <section
      id="cta"
      className="py-16 sm:py-24 md:py-32 bg-electric text-white relative overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-4xl sm:text-6xl md:text-9xl font-headline font-black tracking-tighter mb-6 sm:mb-8"
        >
          {t('cta.title')}
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl md:text-2xl font-body mb-8 sm:mb-12 max-w-3xl mx-auto"
        >
          {t('cta.desc')}
        </motion.p>
