...
export const translations = {
  ...
  ru: {
    ...
    partners: {
      ...
      brandVisibilityItems: [
        'Шапочках для плавания во время заплыва',
        'Купальных костюмах',
        'Халатах и командном мерче',
        'Тренировочной одежде',
        'Полотенцах и официальных материалах',
      ],
  ...
  by: {
    ...
    partners: {
      ...
      brandVisibilityItems: [
        'Шапачках для плавання падчас заплыву',
        'Купальных касцюмах',
        'Халатах і камандным мерчы',
        'Трэніровачнай вопратцы',
        'Ручніках і афіцыйных матэрыялах',
      ],
